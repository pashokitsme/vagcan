...
oracle, and `.archive/research/car/other-ecus.md` for the addressing rules this builds on.
...
`.archive/research/car/other-ecus.md` §1 named itself the moment it was asked for `F187`/`F197` —
...
`.archive/research/car/other-ecus.md` §3's warning that the last two are response ids appearing in the
...
`.archive/research/labels/label-linkage.md` §2.4 named for *measurement* scaling rather than fault names.
