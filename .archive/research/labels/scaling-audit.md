...
Reproduction scripts: `.archive/research/labels/scaling-audit/` (`glyphs.py`, `audit.py`).
...
python3 .archive/research/labels/scaling-audit/glyphs.py   # selftest vs table 531
python3 .archive/research/labels/scaling-audit/audit.py    # all of §1–§4
```
