...
`.archive/research/labels/codes-dat.md` §5 want to sweep 110 000 tables, which is a script's job.
...
def decode_section(tag, payload, iv3to8=None):
    ...
    if iv3to8 is None:
        ...
        # the shifted-IV regime (.archive/research/labels/tttext2.md §3.3)
