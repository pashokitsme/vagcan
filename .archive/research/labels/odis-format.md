...
Companion to `.archive/research/labels/odis-crib.md` (which established that none of it is
encrypted, and used the string pools against the `TTTEXT` cipher) and
`.archive/research/labels/rod-labels.md` (the Ross-Tech container, and the drive that proved the
