...
Companion to `.archive/research/labels/rod-labels.md` (§4.0c, §5) and `.archive/research/labels/label-linkage.md` (§2, §3,
§5.5). `.archive/research/labels/tttext2.md` covers the other candidate and is not this work.
...
a scratch directory and not added to `.archive/research/clb-crack`. The steps are small enough to
