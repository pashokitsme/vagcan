...
Companion to `.archive/research/labels/rod-labels.md` (the container) and
`.archive/research/labels/tttext-codec.md` (the cipher, read §1 and §6 first). The pilot script is
`.archive/research/labels/odis_crib.py`. Working data — the ODIS project, the decoded `[TXT]`
