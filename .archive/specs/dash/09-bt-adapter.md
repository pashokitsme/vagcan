...
> here, is in [`10-c3-recon.md`](../../tasks/done/dash/10-c3-recon.md). Read that first — and
> [`11-ble.md`](../../tasks/done/dash/11-ble.md) for what BLE does carry, which is configuration rather than a
