...
## The roadmap's header, as it stood on 2026-09-13
...
Details of the dash's own state: [`dash/README.md`](../../todo/dash/README.md).
...
`.archive/research/` (`a8d7e8f`), with [`.archive/README.md`](../README.md)
...
A second frontend, opened 2026-08-20 and specified in **[`todo/dash/`](../../todo/dash/README.md)**:
...
ESP32-C3 SuperMini, not an S3 — no ULP, no Bluetooth Classic ([`dash/10-c3-recon.md`](done/dash/10-c3-recon.md)). `watch` is for a laptop on the passenger seat; this is for a glance at
120 km/h.
...
[`.archive/research/labels/odis-format.md`](../research/labels/odis-format.md) §4.1, **split by
...
[`.archive/research/labels/odis-format.md`](../research/labels/odis-format.md) §4.2.
