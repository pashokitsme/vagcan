...
- The link cipher is a **static position-dependent XOR keystream**: `plain[i] =
  ...
  `research/vag-hex-framing.md` and `.archive/research/clb-crack/link_cipher.py`).
...
- Tooling: `.archive/research/clb-crack/` venv (capstone+pefile), `framing_dis.py` (AArch64
...
- Update `.archive/research/clb-crack/link_cipher.py` to derive keystreams from the schedule
