...
sleeps, or it holds the gateway awake and flattens the battery. Detect on bus silence —
and note that "no answer" is the same signal the moving-car guard reads as *moving*, so
the two must not be confused: one is a reason to go quiet, the other a reason to refuse.
Get this right before the first night parked.
