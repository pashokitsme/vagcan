...
//!
//! Shared by the two binaries: `bleecho`, which echoes whatever you type at
//! whatever you pick, and `dashcfg`, which knows what the dash's answers mean.
//! The discovery half is identical, so it lives here rather than being copied.
