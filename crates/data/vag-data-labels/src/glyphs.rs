...
//! row — failed, and `.archive/research/labels/label-linkage.md` §2.4 recorded it as the
//! blocker it was.
//!
...
//! (`.archive/research/car/whole-car-survey.md` §3):
//!
...
///
/// `.archive/research/labels/fault-naming-hop.md` §5.1 measured the substitution as per-table
