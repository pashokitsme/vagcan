...
falls under a floor. CI's `firmware` job runs it. The limits and what they were measured at
live in the script and nowhere else.
...
- Raising a limit is a change to `ram-budget.sh` with its reason beside it.
